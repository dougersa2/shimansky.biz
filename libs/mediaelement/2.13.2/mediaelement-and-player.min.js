...
c){var b=this,e=mejs.MediaFeatures,f=c.getAttribute("autoplay"),f=!("undefined"==typeof f||null===f||"false"===f),g;if(!b.created){b.created=!0;b.media=a;b.domNode=c;if(!(e.isAndroid&&b.options.AndroidUseNativeControls||e.isiPad&&b.options.iPadUseNativeControls||e.isiPhone&&b.options.iPhoneUseNativeControls)){b.buildposter(b,b.controls,b.layers,b.media);b.buildkeyboard(b,b.controls,b.layers,b.media);b.buildoverlays(b,b.controls,b.layers,b.media);b.findTracks();for(g in b.options.features)if(e=b.options.features[g],
b["build"+e])try{b["build"+e](b,b.controls,b.layers,b.media)}catch(h){}b.container.trigger("controlsready");b.setPlayerSize(b.width,b.height);b.setControlsSize();b.isVideo&&(mejs.MediaFeatures.hasTouch?b.$media.bind("touchstart",function(){b.controlsAreVisible?b.hideControls(!1):b.controlsEnabled&&b.showControls(!1)}):(mejs.MediaElementPlayer.prototype.clickToPlayPauseCallback=function(){b.options.clickToPlayPause&&(b.media.paused?b.play():b.pause())},b.media.addEventListener("click",b.clickToPlayPauseCallback,
!1),b.container.bind("mouseenter mouseover",function(){b.controlsEnabled&&!b.options.alwaysShowControls&&(b.killControlsTimer("enter"),b.showControls(),b.startControlsTimer(2500))}).bind("mousemove",function(){b.controlsEnabled&&(b.controlsAreVisible||b.showControls(),b.options.alwaysShowControls||b.startControlsTimer(2500))}).bind("mouseleave",function(){b.controlsEnabled&&(b.media.paused||b.options.alwaysShowControls||b.startControlsTimer(1E3))})),b.options.hideVideoControlsOnLoad&&b.hideControls(!1),
f&&!b.options.alwaysShowControls&&b.hideControls(),b.options.enableAutosize&&b.media.addEventListener("loadedmetadata",function(a){0>=b.options.videoHeight&&null===b.domNode.getAttribute("height")&&!isNaN(a.target.videoHeight)&&(b.setPlayerSize(a.target.videoWidth,a.target.videoHeight),b.setControlsSize(),b.media.setVideoSize(a.target.videoWidth,a.target.videoHeight))},!1));a.addEventListener("play",function(){for(var a in mejs.players){var c=mejs.players[a];c.id==b.id||!b.options.pauseOtherPlayers||
...
g){var c=k.height(),d=k.position(),e=c-c*a;n.css("top",Math.round(d.top+e-n.height()/2));m.height(c-e);m.css("top",d.top+e)}else c=k.width(),d=k.position(),c*=a,n.css("left",Math.round(d.left+c-n.width()/2)),m.width(Math.round(c));else l.show(),p(a,!0),l.hide()},s=function(a){var b=null,c=k.offset();if("vertical"==g){if(b=k.height(),parseInt(k.css("top").replace(/px/,""),10),b=(b-(a.pageY-c.top))/b,0==c.top||0==c.left)return}else b=k.width(),b=(a.pageX-c.left)/b;b=Math.max(0,b);b=Math.min(b,1);p(b);
...
this,d=c.slides.entries.text[a],e=c.slides.entries.imgs[a];"undefined"==typeof e||"undefined"==typeof e.fadeIn?c.slides.entries.imgs[a]=e=b('<img src="'+d+'">').on("load",function(){e.appendTo(c.slidesContainer).hide().fadeIn().siblings(":visible").fadeOut()}):e.is(":visible")||e.is(":animated")||e.fadeIn().siblings(":visible").fadeOut()}},displaySlides:function(){if("undefined"!=typeof this.slides){var a=this.slides,b;for(b=0;b<a.entries.times.length;b++)if(this.media.currentTime>=a.entries.times[b].start&&
this.media.currentTime<=a.entries.times[b].stop){this.showSlide(b);break}}},displayChapters:function(){var a;for(a=0;a<this.tracks.length;a++)if("chapters"==this.tracks[a].kind&&this.tracks[a].isLoaded){this.drawChapters(this.tracks[a]);this.hasChapters=!0;break}},drawChapters:function(a){var c=this,d,e,f=e=0;c.chapters.empty();for(d=0;d<a.entries.times.length;d++){e=a.entries.times[d].stop-a.entries.times[d].start;e=Math.floor(e/c.media.duration*100);if(100<e+f||d==a.entries.times.length-1&&100>
