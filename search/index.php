...
<div class="col-lg-4">
	...
	<div class="module module-clean">
		...
		<script>
			function loadJs(c,b){var a=document.createElement("script");a.type="text/javascript";a.readyState?a.onreadystatechange=function(){if("loaded"==a.readyState||"complete"==a.readyState)a.onreadystatechange=null,b&&b()}:a.onload=function(){b&&b()};a.src=c;document.body.appendChild(a)};
			loadJs("/libs/early.js/1.0/js/early.min.js",function(){
