...
<html>
	<head>
		...
		<link rel="stylesheet" href="/libs/jquery-ui-1.10.3.custom.autocomplete/shimansky.biz/css/smoothness/jquery-ui-1.10.3.custom.min.css" />
				...
				<ul>
					<li><a href="#" class="nav-li-a-group">Сайты</a>
						<ul>
							...
							<li><a href="#" class="nav-li-a-delimiter">&#160;</a></li>
		...
		<script>
			var deferredJS = function () {
				yepnope.injectJs("//ajax.googleapis.com/ajax/libs/jquery/2.0.3/jquery.min.js", function () {
					yepnope.injectJs("/libs/jQuery.mmenu/3.2.7/js/jquery.mmenu.fixed.min.js", function () {
						...
						"undefined"!==typeof window.jQuery&&function(){$("li a.nav-li-a-delimiter").click(function(a){a.preventDefault()});}();
					},{charset:"utf-8"},5E3);
					("undefined"!==typeof earlyIsMobileBrowser&&earlyIsMobileBrowser)||yepnope.injectJs("/libs/jquery-ui/1.10.4/js/jquery-ui.custom.min.js", function () {
